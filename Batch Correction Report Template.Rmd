...
filter_function <- function(data, transform_input, corrected_data, qc_cv_threshold, icc_threshold){
  ...
  print(colnames(qc_df)[technical_cv > qc_cv_threshold])
...
### Impact of Correction on Tecnnical and Biological Precison 
...
2. Intercorrelation Coefficient 
...
filter_function(data = raw_data, transform_input = input$transformer_section_3, corrected_data = TRUE, qc_cv_threshold = input$qc_cv_cutoff, icc_threshold = input$icc_cutoff)
  
})
```


### Export Final Data Matrix
